...
private:
    ...
    std::vector<ClawnDash::Portal> m_speedPortals;
    std::vector<ClawnDash::Portal> m_normalSpeedPortals;
    std::vector<ClawnDash::Portal> m_miniPortals;
    std::vector<ClawnDash::Portal> m_normalPortals;
    std::vector<ClawnDash::Portal> m_gravityPortals;
    std::vector<ClawnDash::Portal> m_normalGravityPortals;
    float m_startX = 0.f;
    float m_startY = 0.f;
    float m_finishX = 0.f;
    float m_groundY = -2.8f;
    float m_ceilingY = 2.8f;
    float m_runSpeed = 0.f;
    float m_gravitySign = 1.f;
    float m_playerScale = 1.f;
    float m_playerX = 0.f;
    float m_playerY = 0.f;
    ...
    uint32_t baseBackgroundColor() const;
